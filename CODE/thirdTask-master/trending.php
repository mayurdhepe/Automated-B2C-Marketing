...
<!-- Begin -->
	...
	<br>
	<form name="postdetails" id="post" method="post" action="keyword.php" enctype="multipart/form-data">
	<label><b>Know What's Trending about:</b></label>
	
                    
					<div class = "form-group">
		<textarea class = "form-control" rows = "1" maxlength = "300" placeholder = "Enter Keyword here..." name="keyword"></textarea>
		
	</div>
		
	
	<label class="btn btn-primary btn-file" style="margin:5px; border-radius: 5px; ">
                    Select<input type="submit" name="selectcat" id="camp" style="display: none;">
                </label>
	...
	<hr>
	<br>
	<form name="postdetails" id="post" method="post" action="places.php" enctype="multipart/form-data">
	<label><b>Get Trending topics related to a place :</b></label>
	<label><b>Know What's TRENDING in :</b></label>
                    
					<div class = "form-group">
		<textarea class = "form-control" rows = "1" maxlength = "300" placeholder = "Enter Where on Earth ID here..." name="place"></textarea>
		
	</div>
		<label><b>(Example : WOEId of Pune = 2295412, Mumbai = 2295411)</b></label>
		<label><b>(Get WOEId of a place from http://www.woeidlookup.com/)</b></label>
