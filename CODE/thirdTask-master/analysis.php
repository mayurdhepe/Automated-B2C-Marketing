...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
	...
	<li class="active"> <a href="#"><i class="icon icon-th-list"></i> <span>Analysis</span></a></li>
...
<br><br><br><br><br>
    ...
    <!--Post window-->
   <form name="postdetails" id="post" method="post" action="sentianalysis.php" enctype="multipart/form-data">
