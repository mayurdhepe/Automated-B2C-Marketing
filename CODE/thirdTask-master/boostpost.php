...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="active"><a href="#"><i class="icon icon-rss"></i> <span>Boost Post</span></a></li>
...
<br><br><br><br><br>
    ...
    <!--Post window-->
   <form name="postdetails" id="post" method="post" action="fuuu.php" enctype="multipart/form-data">
...
<!-- Begin -->
	...
	<label><b>Select Category to Boost:</b></label>
                    <?php
	...
	<label><b>Select Social Media:</b></label>
                    
					<select name="media">
						<li><option value="facebook">Facebook</option></li>
                        <li><option value="instagram">Instagram</option></li>
						<li><option value="twitter">Twitter</option></li>
						<li><option value="linkedin">LinkedIn</option></li>
