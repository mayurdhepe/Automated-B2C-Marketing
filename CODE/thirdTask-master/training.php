...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-th-list"></i> <span>Manage a Campaign</span></a></li>
      <li class="submenu"> <a href="../graph/graph.php"><i class="icon icon-th-list"></i> <span>Twitter Analysis</span></a></li>
	<li class="submenu"> <a href="../graph/graph1.php"><i class="icon icon-th-list"></i> <span>Facebook Analysis</span></a></li>
...
<br><br><br><br><br><br>
<h2>Portal to train system for Twitter<h2>
<br><br>
    <!--Post window-->
   <form name="postdetails" id="post" method="post" action="twittertrain.php" enctype="multipart/form-data">
...
<h3>Select Category to POST<h3>
	
	<select name= "category">
	  <option value="Valentine">Valentine</option>
	  <option value="Winter">Winter deals</option>
       ...
       <img id="blah" src="#" alt="" />
            ...
            <div class="row-fluid">
				...
				<div class="btn-group" style="float: right;">
                    <button data-toggle="dropdown" class="btn btn-primary dropdown-toggle" style="border-radius: 5px; margin: 5px"><i class="fa fa-paper-plane" aria-hidden="true"></i> Post <span class="caret"></span></button>
                    <ul class="dropdown-menu">
