<?php
 ...
 session_start();
  ...
  $sql="INSERT INTO campaign(name,category,username)VALUES('$cname','$category','$username')";
  ...
  mysqli_close($db1);
	echo "<script type='text/javascript'>alert('Campaign Created!');</script>";
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
	<li class="active"><a href="existcamp.php"><i class="icon icon-home"></i> <span>HOME</span></a> </li>
