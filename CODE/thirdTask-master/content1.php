...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
  <li class="active"> <a href="#"><i class="icon icon-bar-chart"></i> <span>Post to Campaign</span></a> </li>
...
Category:  <?php echo $cname;?><h3>
    ...
    <!--Post window-->
   <form name="postdetails" id="post" method="post" action="../darknet/objrec1.php" enctype="multipart/form-data">
