...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
        <li class="active"> <a href="#"><i class="icon icon-bar-chart"></i> <span>Set Reminder</span></a> </li>
...
<br><br><br><br><br>
    ...
    <h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Set Reminder</h2>
    <!--Post window-->
   <form name="postdetails" id="post" method="post" action="remind.php" enctype="multipart/form-data">
...
<!-- Begin -->
	...
	else
	{
     ...
     while ($row = $result->fetch_object()) 
	 {
		...
		<textarea class = "form-control" rows = "4" maxlength = "300" placeholder = "Enter Reminder message to send here..." name="desc"></textarea>
		
	</div>
	<br>
	
	<div class = "form-group">
		<textarea class = "form-control" rows = "1" maxlength = "300" placeholder = "Enter Email Address to send Email to..." name="mailid"></textarea>
		
	</div>
	<br>
	<label>(Email will be sent 30 mins prior to Post timing)</label>
	<br>
	<label class="btn btn-primary btn-file" style="margin:5px; border-radius: 5px; ">
                    SET NOW!<input type="submit" name="schedule" id="camp" style="display: none;">
                </label>
