...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
  <li class="active"> <a href="#"><i class="icon icon-home"></i> <span>BOOST Now</span></a> </li>
...
<!-- Begin -->
	<h3><b>Recommended Target Audience:</b></h3>
	<label>Men of Age Range 21 to 40. Interests: Fitness. Locality: Mumbai,Pune,Nashik</label>
	<br><br>
  ...
  <br>
	<label><b>Age Range:</b></label>
					...
					while($age <= 65) {?>
                        ...
                        <li><option value="<?php $age?>"><?php echo $age;?></option></li>
						<?php $age++;
					}
					?>
					</select>
					...
					while($age >= 15) {?>
                        ...
                        <li><option value="<?php echo $age;?>"><?php echo $age;?></option></li>
						<?php $age--;
					}?>
	...
	<br>
		...
		<br>
		<input type="number" name="quantity" placeholder="65" min="65">
		<br>
