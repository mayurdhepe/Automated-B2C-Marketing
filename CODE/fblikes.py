...
def main():
  ...
  #pic = api.put_photo(image=open("img.jpg", 'rb'),
                  #album_path="879858028854213" + "/photos", message = "This is Mercedes!")

  likes = api.get_connections(id='168793550581174', connection_name='likes?&summary=total_count')
  print likes
