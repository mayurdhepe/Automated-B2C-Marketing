...
//$id = "879858028854213";
	...
	$sql= "INSERT INTO facebook_img(postid,imgid)VALUES('$fbid1','$newname')";
...
echo "<script type='text/javascript'>alert('Advertisement Posted on FACEBOOK');</script>";
	...
	$loginUrl = $helper->getLoginUrl('http://cliq.globalsuperelite.com/facebook_post/genfbit.php', $permissions);
