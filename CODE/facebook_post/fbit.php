...
if (isset($accessToken)) {
	...
	try {
		...
		//$message = 'my photo';
			...
			/* $data= ['message' => "Hello to all", 'url' => "http://cliq.globalsuperelite.com/justpics/draw2-2.jpg"];
		$request = $fb->post('/me/feed',$data); 
             */                    			

				$data = array(
		//'picture' => "https://cdn.shopclues.com/images/thumbnails/55189/200/200/AGIFTS1139031486063550.jpg",
		        'message' => "anjd",
		'link' => "http://cliq.globalsuperelite.com/facebook_post/index.php",
		//'url' => "http://cliq.globalsuperelite.com/justpics/draw2.jpg"
